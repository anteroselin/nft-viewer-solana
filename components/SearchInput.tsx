...
const SearchInput = ({ onChangeHandler=()=>{}, text="", className="", onClickHandler=()=>{} }) => {
  return (
    <div className={`${className} relative`}>
        <input className='w-full text-2 pl-4 pr-10 py-2 rounded-md border-2 border-black' onChange={e => onChangeHandler(e.target.value)} value={text} placeholder='search owner public key'></input>
